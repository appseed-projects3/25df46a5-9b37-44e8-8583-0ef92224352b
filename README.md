...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-07 12:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/25df46a5-9b37-44e8-8583-0ef92224352b.git
$ cd 25df46a5-9b37-44e8-8583-0ef92224352b
```
